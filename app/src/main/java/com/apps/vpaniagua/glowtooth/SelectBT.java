...
public class SelectBT extends AppCompatActivity {
    ...
    public void onResume()
    {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, R.layout.devices);//<-<- PARTE A MODIFICAR >->->
        // Presenta los disposisitivos vinculados en el ListView
        IdLista = (ListView) findViewById(R.id.lstLista);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(SelectBT.this, MainActivity.class);//<-<- PARTE A MODIFICAR >->->
